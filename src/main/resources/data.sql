...
insert into user (name, surname, email, password, enabled, type, role,broj_indexa,semestar,smer_id) values ('Djordje', 'Rogic ', 'client@gmail.com', '$2a$10$noSRMxRJjDHt2Ky.E1QHYupSHa8tTZ0fyVXvWE5o73PKdlrLgSyMG', true, 'STUDENT', 'ROLE_STUDENT','ra56-2016',1,1);
